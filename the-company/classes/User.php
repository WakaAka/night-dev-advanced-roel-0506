...
<?php 
    ...
    class User extends Database {
        # The logic of the application will be placed here(CRUD, data manipulation, arithmetic operations)
        ...
        public function login($request) {
            ...
            if($result->num_rows == 1) {
                # If the username is existing it will return 1, otherwise return 0 if not found.

                $user = $result->fetch_assoc();
                # $user = ['id' => 1, 'username' => 'mary', 'password' => '$2y$1qu'];
        ...
        public function update($request, $files) {
            ...
            $tmp_photo = $files['photo']['tmp_name']; # Indicate the path of the file inside the temporary storage in your computer. The file is place in a temporary folder before moving it to the destination
            ...
            if($this->conn->query($sql)) {
                ...
                if($photo) {
                    ...
                    if($this->conn->query($sql)) {
                        # save the image in designated folder
