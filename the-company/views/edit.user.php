    ...
    <main class="row justify-content-center gx-0 mb-5">
        <div class="col-4">
            ...
            <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                            <label for="first-name" class="form-lavel">First Name</label>
                            <input type="text" name="first_name" id="first_name" class="form-control" value="<?= $user['first_name']?>" required autofocus>
                        </div>

                        <div class="mb-3">
                            <label for="last-name" classs="form-label">Last Name</label>
                        ...
                        <div class="text-end">
                            ...
                            <button type="sibmit" class="btn btn-warning btn-sm px-5">Save</button>
                        </div>
            </form>
        </div>
    </main>
